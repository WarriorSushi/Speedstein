...
describe('PdfService', () => {
    ...
    beforeEach(() => {
        ...
        pdfService = new PdfService(mockBrowserPool);
    });
    ...
    describe('sanitizeOptions', () => {
        it('should remove potentially dangerous options', () => {
            ...
            const sanitized = pdfService.sanitizeOptions(dangerousOptions);
