...
import { TIER_QUOTAS, type PricingTier } from '../lib/constants';

/**
 * Rate limit configuration
 */
export interface RateLimitConfig {
  /** KV namespace binding for rate limit storage */
  kv: KVNamespace;
 ...
 */
export function createDemoRateLimiter(kv: KVNamespace): RateLimiter {
 ...
 * @returns Configured rate limiter
 */
export function createApiRateLimiter(kv: KVNamespace): RateLimiter {
  return new RateLimiter({
    kv,
 ...
 */
export function getTierRateLimit(planTier: PricingTier): number {
 ...
 */
export function getTierBurstLimit(planTier: PricingTier): number {
