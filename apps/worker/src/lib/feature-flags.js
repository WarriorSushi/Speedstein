 ...
 * ```
 */
export function shouldUseDO(env, userId) {
 ...
 */
function getRolloutPercentage(env) {
 ...
 */
export function isRpcEndpointEnabled(env) {
 ...
 */
export function shouldRestUsesDurableObjects(env) {
 ...
 */
export function getRolloutStageName(env) {
    if (!isDurableObjectsEnabled(env)) {
        return 'disabled';
    }
 ...
 * ```
 */
export function getFeatureFlagContext(env, userId) {
