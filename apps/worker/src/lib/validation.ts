 ...
 */
export function validateBrowserPoolState(data: unknown) {
 ...
 */
export function validatePdfOptions(data: unknown) {
 ...
 */
export function validatePdfGenerationRequest(data: unknown) {
...
export type BrowserPoolState = z.infer<typeof BrowserPoolStateSchema>;
export type PdfOptions = z.infer<typeof PdfOptionsSchema>;
export type PdfGenerationRequest = z.infer<typeof PdfGenerationRequestSchema>;
export type RpcSessionMetadata = z.infer<typeof RpcSessionMetadataSchema>;
